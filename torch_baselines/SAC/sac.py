...
class SAC(Deterministic_Policy_Gradient_Family):
    def __init__(self, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, action_noise = 0.1, train_freq=1, batch_size=32, policy_delay = 2,
        ...
        super(SAC, self).__init__(env, gamma, learning_rate, buffer_size, train_freq, batch_size, 
